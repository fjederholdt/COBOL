       ...
       FILE-CONTROL.
           SELECT CUSTOMER-FILE ASSIGN TO "Customerinfo.txt"
               ORGANIZATION IS LINE SEQUENTIAL.
           SELECT ACCOUNT-FILE ASSIGN TO "Accountinfo.txt"
               ORGANIZATION IS LINE SEQUENTIAL.
           SELECT OUTPUT-FILE ASSIGN TO "CUSTOMERACCOUNT.txt"
               ORGANIZATION IS LINE SEQUENTIAL.
       ...
       FORMAT-ACCOUNT-INFO.
           MOVE SPACES TO CUSTOMER-INFO
           STRING ACCOUNT-NUMBER OF ACCOUNT-RECORD DELIMITED BY SPACE
               " " DELIMITED BY SIZE
               ACCOUNT-TYPE OF ACCOUNT-RECORD DELIMITED BY SPACE
               " " DELIMITED BY SIZE
               ACCOUNT-BALANCE OF ACCOUNT-RECORD(1:7) "." 
               ACCOUNT-BALANCE OF ACCOUNT-RECORD(8:2)
               " " DELIMITED BY SIZE
               CURRENCY-CODE OF ACCOUNT-RECORD DELIMITED BY SPACE
               INTO CUSTOMER-INFO
           END-STRING.
